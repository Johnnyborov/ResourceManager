...
// create a cpp file (e.g. resources/res.txt.cpp) containing global extern array of const char
...
// the beginning of global extern array of const char and its size (see -data option description)
...
void createResourceDataSourceFile(char* resource_name, char* resource_file_name, char* output_file_name) {
  ...
  ofs << "#include <cstddef>\n";
  ofs << "extern const char _resource_" << modified_name << "_data[] = {\n";
...
void generateResourcesConfigSourceFile(char* resource_names_list, char* config_file_name) {
  ...
  do {
    ...
    ofs <<
      ...
      "    extern const char _resource_" << modified_name << "_data[];\n"
